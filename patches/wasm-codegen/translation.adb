...
package body Translation is
   ...
   begin
      ...
      Simple_IO.Put_Line_Err ( "DIAG: Translation.Initialize done");
      null;
      Coverage.Cover_Initialize;
      Simple_IO.Put_Line_Err ( "DIAG: Coverage.Cover_Initialize done");
      null;
   end Initialize;
   ...
   begin
      ...
      while Decl /= Null_Iir loop
         ...
         then
            ...
            Simple_IO.Put_Line_Err ( "TTIS: body");
            null;
            Chap7.Translate_Implicit_Subprogram_Body (Decl);
            Simple_IO.Put_Line_Err ( "TTIS: done");
            null;
            Simple_IO.Put_Line_Err ( "TTIS: get_chain");
            null;
            Decl := Get_Chain (Decl);
            Simple_IO.Put_Line_Err ( "TTIS: loop_top");
            null;
         else
            Simple_IO.Put_Line_Err ( "TTIS: non-implicit, exiting loop");
            null;
            exit;
         end if;
      end loop;
      Simple_IO.Put_Line_Err ( "TTIS: loop_done");
      null;
   ...
   begin
      Simple_IO.Put_Line_Err ( "TS: Update_Node_Infos");
      null;
      Update_Node_Infos;
      Simple_IO.Put_Line_Err ( "TS: New_Debug_Comment_Decl");
      null;
      ...
      Simple_IO.Put_Line_Err ( "TS: Translate_Bool_Type_Declaration");
      null;
